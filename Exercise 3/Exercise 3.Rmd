...
```{r fig1a1, echo = FALSE, include=TRUE, fig.cap="\\label{fig:1a1} Display of seismic data $L_D$.", fig.height=14, fig.width=14}
# Figure 1
...
image.plot(topo.li, main = "Display of seismic data, LD", horizontal = T, legend.lab = "d", cex.lab=clab, cex.main =cmain, cex.axis=caxis, cex = 2)
...
```{r fig1b1, echo = FALSE, include=TRUE, fig.cap="\\label{fig:1b1} Display of probabilies", fig.height=14, fig.width=14}
...
image.plot(topo.li, main = "Display of probabilies, LD", horizontal = T, legend.lab = "p", cex.lab=clab, cex.main =cmain, cex.axis=caxis, cex = 2)
contour(topo.li,add=T)
par(mfrow=c(1,1))
...
```{r fig1b2, echo = FALSE, include=TRUE, fig.cap="\\label{fig:1b2} Display of six posterior realizations of $L_D$.", fig.height=25, fig.width=20}
...
for(i in 1:6){
  ...
  image(topo.li, nlevel = 2, main = paste0("Simulation ", i), col = c("#F7F396", "purple"), cex.lab=clab, cex.main =cmain, cex.axis=caxis)
}
par(fig = c(0, 1, 0, 1), oma = c(0, 0, 0, 0), mar = c(0, 0, 0, 0), new = TRUE)
plot(0, 0, type = "n", bty = "n", xaxt = "n", yaxt = "n")
legend("bottom", c("Sand", "Shale"), xpd = TRUE, horiz = TRUE, inset = c(0, 
    0), bty = "n", fill = c("#F7F396", "purple"), cex = 5)
par(mfrow=c(1,1))
par(opar)
...
```{r fig1b3, echo = FALSE, include=TRUE, fig.cap="\\label{fig:1b3} Plot of MMAP, expected values and variance with uniform prior", fig.height=25, fig.width=12}
...
image.plot(topo.li, main = "Expectance, LD", horizontal = F, legend.lab = "Expectance", cex.lab=clab, cex.main =cmain, cex.axis=caxis)
contour(topo.li,add=T)

topo.li <- interp(seismic$x, seismic$y, var)
image.plot(topo.li, main = "Variance, LD", horizontal = F, legend.lab = "Variance", cex.lab=clab, cex.main =cmain, cex.axis=caxis)
contour(topo.li,add=T)
 

topo.li <- interp(seismic$x, seismic$y, MMAP)
image(topo.li, main = "MMAP", nlevel = 2, col = c("#F7F396", "purple"), cex.lab=clab, cex.main =cmain, cex.axis=caxis)
...
```{r fig1c1, echo = FALSE, include=TRUE, fig.cap="\\label{fig:1c1}Display of observed data in $D_c$", fig.height=5, fig.width=5}
# c)
clab = 1
cmain = 1
caxis = 1
...
plot(0, 0, type = "n", bty = "n", xaxt = "n", yaxt = "n")
legend("bottom", c("Sand", "Shale"), xpd = TRUE, horiz = TRUE, inset = c(0, 
    0), bty = "n", fill = c("#F7F396", "purple"), cex = 1)
...
```{r fig1c22, echo = FALSE, include=TRUE, fig.cap="\\label{fig:1c22} Percentage equality of samples compared to sample distance", fig.height=5, fig.width=5}
...
```{r fig1c2, echo = FALSE, include=TRUE, fig.cap="\\label{fig:c2} Gibbs sampler initial and last iteration, 2500 steps.", fig.height=8, fig.width=15}
...
plot(0, 0, type = "n", bty = "n", xaxt = "n", yaxt = "n")
legend("bottom", c("Sand", "Shale"), xpd = TRUE, horiz = TRUE, inset = c(0, 
    0), bty = "n", fill = c("#F7F396", "purple"), cex = 2.2)
par(opar)
```
...
```{r fig1c4, echo = FALSE, include=TRUE, fig.cap="\\label{fig:c4} Estimators from independent gibbs sample", fig.height=25, fig.width=15}
clab = 3.5
cmain = 3.5
caxis = 3.5

par(mfrow=c(3,1), mar = c(7.5,2.5,2.5,2.5))
topo.li <- interp(df$x, df$y, df$p)
image.plot(topo.li, main = "Expectance, LD", horizontal = F, legend.lab = "Expectance", cex.lab=clab, cex.main =cmain, cex.axis=caxis, cex = 2)
contour(topo.li,add=T)

topo.li <- interp(seismic$x, seismic$y, df$var)
image.plot(topo.li, main = "Variance, LD", horizontal = F, legend.lab = "Variance", cex.lab=clab, cex.main =cmain, cex.axis=caxis, cex = 2)
contour(topo.li,add=T)
 

topo.li <- interp(seismic$x, seismic$y, df$mmap)
image(topo.li, main = "MMAP", nlevel = 2, col = c("#F7F396", "purple"), cex.lab=clab, cex.main =cmain, cex.axis=caxis, cex = 2)
legend("bottom", c("Sand", "Shale"), xpd = TRUE, horiz = TRUE, inset = c(0, 
    0), bty = "n", fill = c("#F7F396", "purple"), cex = 4)
