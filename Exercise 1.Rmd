...
\end{equation}
Applying this to our realisation we get: Â = `r mean_length` and Var(Â ) = `r var_length`
...
\end{equation}
With our data we get: Ã =  `r tilde.A`
